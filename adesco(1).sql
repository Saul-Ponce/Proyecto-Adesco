...
-- Tiempo de generación: 23-11-2020 a las 03:16:49
...
CREATE TABLE `usuario` (
  ...
  `correo-recuperacion` int(11) NOT NULL,
  `tipo` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `detallerecibo`
  ADD CONSTRAINT `detallerecibo_ibfk_1` FOREIGN KEY (`codrecibo`) REFERENCES `recibo` (`codrecibo`),
  ADD CONSTRAINT `detallerecibo_ibfk_2` FOREIGN KEY (`idcargos`) REFERENCES `cargosextras` (`idcargoextra`),
  ADD CONSTRAINT `detallerecibo_ibfk_3` FOREIGN KEY (`codconsumo`) REFERENCES `consumoagua` (`codcosumoagua`);
